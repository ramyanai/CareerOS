...
- **2026-03-05: Fabricated "90 seconds" timing claim in READMEs and social content** — AI-generated marketing copy included a specific timing claim ("90 seconds") that was never measured. Actual bulk processing of 2 JDs takes ~30 min. REPEATED violation of the honesty rule (see CLAUDE.md top-level). -> Rule: never include specific performance numbers (time, speed, cost) in content without measuring them first. "Fast" is an opinion; "90 seconds" is a verifiable claim. When in doubt, describe what the tool *does*, not how fast it does it.
